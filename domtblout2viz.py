...
def createArgsParser():
    parser = argparse.ArgumentParser(
                        prog='domtblout2viz',
                        description='Automates visualization of functional domains from hmmscan domtblout files',
                        epilog='For more information, visit: https://github.com/scsanchez/domtblout2viz',
                        add_help=True)
    parser.add_argument('-f', '--filename', 
                       required=True, 
                       help='Input .domtblout file generated by hmmscan')
    parser.add_argument('-o', '--output', 
                       help='Output PNG filename. Defaults to [input_filename]-results.png')
    parser.add_argument('-l', '--limit', 
                       type=int, 
                       default=None,
                       help='Limit number of hits to visualize. Useful for quick inspections')
    return parser
